...
@Component({
  ...
  template: `
    <div
      class="border-primary border rounded-sm px-8 my-1 md:px-3 md:mx-1 lg:px-3 lg:py-6 py-4 flex justify-center items-center gap-5 transition hover:border-slate-400 hover:bg-gray-200 duration-300"
    >
